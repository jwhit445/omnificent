...
namespace DiscordBotTests {
    ...
    public class PugMatchTests {
        ...
        private async Task<RoCoPugService> GetPugService() {
            RoCoPugService pugService = new RoCoPugService(_userService.Object, _embedService.Object, _matchService.Object, _channelSettings.Object, _emoteSettings.Object);
